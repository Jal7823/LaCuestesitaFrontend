    ...
    >
      ...
      <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full">
        ...
        <div className="flex items-center gap-4 flex-wrap mb-8">
          <button className="bg-[#BD85FC] text-white py-2 px-4 rounded-xl">
            Cenando
          </button>
          <button className="text-[#BD85FC] py-2 px-4 rounded-xl border border-gray-500">
            Para llevar
          </button>
          <button className="text-[#BD85FC] py-2 px-4 rounded-xl border border-gray-500">
            Envio
        ...
        <div className="bg-[#262837] absolute w-full bottom-0 left-0 p-4">
          ...
          <div>
            <button className="bg-[#BD85FC] w-full py-2 px-4 rounded-lg">
              Continue to payment
            </button>
          </div>
        </div>
